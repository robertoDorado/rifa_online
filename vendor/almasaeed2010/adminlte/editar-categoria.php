...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $arrayCategory = $faq->getCategoryId($id);
}
?>
<!DOCTYPE html>
<html lang="pt-br">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form id="select--form-registrar-sorteio" method="POST" action="controller/atualizar-categoria-faq.controller.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="nome-categoria">Nome da categoria</label>
                    <input value="<?php echo $arrayCategory['categoria']; ?>" type="text" name="nomeCategoria" class="form-control" id="nome-categoria" placeholder="Nome da Categoria">
                    <input type="hidden" name="id" value="<?php echo $arrayCategory['id']; ?>">
                  </div>
