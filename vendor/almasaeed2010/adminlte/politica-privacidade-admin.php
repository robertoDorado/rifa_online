...
$arrayGetAllPolitica = $politica->getAll();
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Política de privacidade</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Política de privacidade</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="controller/registrar-politica-privacidade.controller.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="titulo">Título</label>
                    <input type="text" name="titulo" class="form-control" id="titulo" placeholder="Política de Privacidade">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="card card-outline card-info">
                      <div class="card-body">
                        <textarea name="texto" id="summernote"></textarea>
                      </div>
                    </div>
                  </div>
          ...
          <?php if(isset($_GET['registerPolitica'])): ?>
            <div class="alert alert-success text-center">Politica registrada com sucesso</div>
          <?php endif; ?>

          <?php if(isset($_GET['limitPolitica'])): ?>
            <div class="alert alert-danger text-center">Já existe um registro  de política de privacidade</div>
          <?php endif; ?>

          <?php if(isset($_GET['updatePolitica'])): ?>
            <div class="alert alert-warning text-center">Política de privacidade atualizado com sucesso</div>
          <?php endif; ?>

            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Tabela de Politica de Privacidade</h3>
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap tr_search">
                  ...
                  <tbody id="table">
                    <?php if($arrayGetAllPolitica != array()): ?>
                    <?php foreach($arrayGetAllPolitica as $politicaPrivacidade): ?>
                    <tr>
                      <td>#<?php echo substr(md5($politicaPrivacidade['id']), 0, 3); ?></td>
                      <td><div class="overflow"><?php echo $politicaPrivacidade['titulo']; ?></div></td>
                      <td><div class="overflow"><?php echo $politicaPrivacidade['texto']; ?></div></td>
                      <td><a href="editar-politica-privacidade.php?id=<?php echo $politicaPrivacidade['id']; ?>" class="btn btn-primary">Editar</a></td>
                      <td><a id="select--link-excluir-politica" href="controller/excluir-politica-privacidade.controller.php?id=<?php echo $politicaPrivacidade['id']; ?>" class="btn btn-danger">Excluir</a></td>
                    </tr>
                    <?php endforeach; ?>
                    <?php endif; ?>
                  </tbody>
            ...
            <!-- Ajax Delete -->
              <script>
                ...
                document.querySelector('#select--link-excluir-politica').addEventListener('click', (e) => {
                  e.preventDefault()
                  ...
                  xhr.open("POST", "controller/excluir-politica-privacidade.controller.php")
                  xhr.send(formData)
                })
              </script>
            <!-- Ajax Delete -->
