...
if(isset($_GET['id']) && !empty($_GET['id'])){
  ...
  header("Location: politica-privacidade-admin.php");
}

$arrayPoliticaById = $politica->getPoliticaPrivacidadeById($id);
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Editar Política de privacidade</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Editar Política de privacidade</a></li>
      ...
      <div class="container-fluid">
        ...
        <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Editar Política de privacidade</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="controller/atualizar-politica-privacidade.controller.php">
                <div class="card-body">
                  <div class="form-group">
                    <label for="titulo">Título</label>
                    <input type="text" value="<?php echo $arrayPoliticaById['titulo']; ?>" name="titulo" class="form-control" id="titulo" placeholder="Política de Privacidade">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="card card-outline card-info">
                      <div class="card-body">
                        <textarea name="texto" id="summernote"><?php echo $arrayPoliticaById['texto']; ?></textarea>
