...
if(isset($_GET['id'])){
    $id = $_GET['id'];
    $arrayFaq = $faq->getFaqById($id);
}
$arrayCategory = $faq->getAllCategory();
// foreach($arrayFaq as $faqName){
//     $arrayCategoriaName = $faq->getCategoriaName($faqName['id_categoria']);
//     print_r($arrayCategoriaName);
// }
?>
<!DOCTYPE html>
<html lang="pt-br">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Editar Pergunta</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      ...
      <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="controller/atualizar-faq.controller.php">
                <div class="card-body">
                <?php if($arrayCategory != array() && $arrayFaq != array()): ?>
                <?php foreach($arrayFaq as $faqName): ?>
                  <div class="form-group">
                    <label for="pergunta">Registro da pergunta</label>
                    <input value="<?php echo $faqName['pergunta']; ?>" required type="text" name="pergunta" class="form-control" id="pergunta" placeholder="Registro da pergunta">
                  </div>
                  <div class="form-group">
                    <label for="resposta">Registro da resposta</label><br>
                    <textarea value="<?php echo $faqName['resposta']; ?>" required name="resposta" id="resposta" cols="143" rows="5"><?php echo $faqName['resposta']; ?></textarea>
                  </div>
                  <div class="form-group">
