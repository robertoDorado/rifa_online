...
$countUserClients = $user->getCountClientUsers();
$countPurchase = $cart->getCountPurchase();
$countSorteio = $sorteio->getAllCountContest();
$totalEngajamento = $countPurchase / $countUserClients * 100;
?>
<!DOCTYPE html>
<html lang="pt-br">
<head>
        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                <h3><?php echo $countSorteio; ?></h3>

                <p>Total de sorteios</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                <h3><?php echo $totalEngajamento; ?><sup style="font-size: 20px">%</sup></h3>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                <h3><?php echo $countUserClients; ?></h3>
