        ...
        <div class="row">
          ...
          <section class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="controller/atualizar-blog.controller.php" enctype="multipart/form-data">
                <div class="card-body">
                  <div class="form-group">
                    <label for="titulo_post">Titulo do post</label>
                    <input type="text" value="<?php echo $currentPost['titulo']; ?>" name="titulo_post" class="form-control" id="titulo_post" placeholder="Título do Post">
                  </div>
                  <div class="form-group">
                    <label for="texto_blog">Texto do Blog</label><br>
                    <!-- <textarea maxlength="20000" class="form-control" name="texto_blog" id="texto_blog" cols="143" rows="5"><?php echo $currentPost['texto']; ?></textarea> -->
                    <!-- Main content -->
                    <section class="content">
                        <div class="row">
                          <div class="col-md-12">
                            <div class="card card-outline card-info">
                              ...
                              <!-- /.card-header -->
                              <div class="card-body">
                                <textarea value="<?php $currentPost['texto']; ?>" maxlength="20000" id="summernote" cols="137" rows="5" class="form-control" name="texto_blog"><?php echo $currentPost['texto'] ?></textarea>
                              </div>
