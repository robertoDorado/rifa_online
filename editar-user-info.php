...
<!-- fim do preloader --> 
  ...
  <section class="hero">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <form action="pages/controller/editar-nome.controller.php?id=<?php echo $data['id']; ?>" method="POST">
                <h2>Mude os seus dados aqui.</h2><br>
                    <div class="form-group">
                        <label for="nome">Nome:</label><br>
                        <input value="<?php echo $data['nome']; ?>" class="form-control" type="text" name="nome" id="nome"><br><br>
                    </div>
                    <div class="form-group">
                        <label for="aniversario">Aniversario:</label><br>
                        <input value="<?php echo $data['aniversario']; ?>" class="form-control" type="date" name="aniversario" id="aniversario"><br><br>
                    </div>
                    <div class="form-group">
                        <label for="email">Email</label><br>
                        <input style="background-color:transparent;" value="<?php echo $data['email']; ?>" class="form-control" type="email" name="email" id="email" readonly><br><br>
                    </div>
                    <div class="form-group">
                        <label for="telefone">Telefone</label><br>
                        <input data-js="telefone" value="<?php echo $data['telefone']; ?>" class="form-control" type="text" name="telefone" id="telefone"><br><br>
                    </div>
                    <div class="form-group">
                        <label for="celular">Celular</label><br>
                        <input data-js="celular" value="<?php echo $data['celular']; ?>" class="form-control" type="text" name="celular" id="celular"><br><br>
                    </div>
                    <div class="form-group">
                        <label for="endereco">Endereço:</label><br>
                        <input value="<?php echo $data['endereco']; ?>" class="form-control" type="text" name="endereco" id="endereco"><br><br>
                    </div>
