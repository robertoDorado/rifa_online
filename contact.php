        ...
        <div class="row justify-content-center">
          <div class="col-lg-6">
            <div class="section-header text-center">
              ...
              <p>Entre me contato conosco, assim que possível retornamos o contato.</p>
            </div>
          </div>
          <div class="col-lg-12">
              ...
              <div class="row">
                <div class="col-lg-6">
                  <div class="contact-form-wrapper">
                    ...
                    <form method="POST" action="pages/controller/contato.controller.php">
                      <div class="form-group">
                        <label>Nome <sup>*</sup></label>
                        <input value="<?php echo $data['nome']; ?>" type="text" name="nome" id="name" placeholder="Seu nome">
                      </div>
                      <div class="form-group">
                        <label>Email <sup>*</sup></label>
                        <input value="<?php echo $data['email']; ?>" type="email" name="email" id="email" placeholder="Email">
                      </div>
                      <div class="form-group">
                        <label>Assunto <sup>*</sup></label>
                        <input type="text" name="assunto" id="subject" placeholder="Assunto">
                      </div>
                      <div class="form-group">
                        <label>Mensagem <sup>*</sup></label>
                        <textarea name="mensagem" id="mensagem" placeholder="Mensagem"></textarea>
                      </div>
                      <div class="form-group">
                        <button type="submit" class="cmn-btn w-100">Enviar</button>
                      </div>
                ...
                <div class="col-lg-6">
                  <div class="contact-info-wrapper">
                    <div class="d-flex flex-wrap justify-content-between w-100">
                      <div style="visibility:hidden;" class="contact-info">
                        <div class="contact-info__icon"><img src="assets/images/icon/contact/1.png" alt="image"></div>
                      ...
                      <div style="visibility:hidden;" class="contact-info">
                        <div class="contact-info__icon"><img src="assets/images/icon/contact/2.png" alt="image"></div>
                        <div class="contact-info__content">
                          <p>Email</p>
                          <span>marcelpro2014@gmail.com</span>
                        </div>
                      </div><!-- contact-info end -->
                    </div>
