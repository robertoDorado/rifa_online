...
$arrayFaqById = $faq->getFaqByIdCategoria($id);
?>
          ...
          <div class="col-lg-12">
            <div class="faq-top-wrapper pt-120">
              <div class="section-header text-center">
                <span class="section-sub-title">Você tem perguntas?</span>
                <h2 class="section-title">NÓS TEMOS RESPOSTAS</h2>
                <p>Não hesite em nos enviar um e-mail caso não encontre o que procura.</p>
              </div>
              ...
              <?php if($arrayCategory != array()): ?>
                <?php foreach($arrayCategory as $category): ?>
                  <li class="nav-item select--categoria" role="presentation">
                    <?php if($id == $category['id']): ?>
                      <a aria-selected="true" class="nav-link active" href="pages/controller/retornar-faq.controller.php?id=<?php echo $category['id'];?>"><?php echo $category['categoria']; ?></a>
                    <?php else: ?>
                      <a aria-selected="false" class="nav-link" href="pages/controller/retornar-faq.controller.php?id=<?php echo $category['id'];?>"><?php echo $category['categoria']; ?></a>
                    <?php endif; ?>
                  </li>
                  <?php endforeach; ?>
                  <?php endif; ?>
            ...
            <div class="faq-body-wrapper">
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade" id="ticket" role="tabpanel" aria-labelledby="ticket-tab">
                  ...
                  <?php if($arrayFaqById != array()): ?>
                    <?php foreach($arrayFaqById as $faqById): ?>
                    <div class="card">
                      <div class="card-header" id="h-1">
                        <button class="btn btn-link btn-block text-left select--pergunta" type="button" data-toggle="collapse" data-target="#collapse1" aria-expanded="true" aria-controls="collapse1">
                          <?php echo $faqById['pergunta']; ?>
                        </button>
                      </div>
                      <div id="collapse1" class="collapse show" aria-labelledby="h-1" data-parent="#faqAcc-one">
                        <div class="card-body">
                          <p class="select--resposta"><?php echo $faqById['resposta']; ?></p>
                        </div>
                      </div>
                    </div>
                    <?php endforeach; ?>
                  <?php endif; ?>
                    ...
                    <!-- <div class="card">
                      ...
                      <div id="collapse2" class="collapse" aria-labelledby="h-2" data-parent="#faqAcc-one">
                        <div class="card-body">
...
<script>
  ...
  if(data.id != undefined){
    document.querySelector('#ticket').removeAttribute('class')
  } 
</script>