          ...
          <div class="col-lg-4">
            ...
            <div class="user-action-card">
              <ul class="user-action-list">
                <li><a href="user.php">My Tickets <span class="badge">04</span></a></li>
                <li><a href="user-info.php">Personal Information</a></li>
                <li><a href="user-transaction.php">Transactions</a></li>
                <li><a href="user-referral.php">Referral Program</a></li>
                <li class="active"><a href="user-lottery.php">Favorite Lotteries</a></li>
            ...
            <div class="row mt-30  mb-none-30">
              ...
              <div class="col-xl-6 col-lg-12 col-md-6 mb-30">
                <div class="contest-card">
                  <a href="#0" class="item-link"></a>
                  <div class="contest-card__thumb">
                    <img src="assets/images/contest/15.png" alt="image">
                    <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                    <div class="contest-num">
                      <span>contest no:</span>
                      <h4 class="number">b2t</h4>
              ...
              <div class="col-xl-6 col-lg-12 col-md-6 mb-30">
                <div class="contest-card">
                  <a href="#0" class="item-link"></a>
                  <div class="contest-card__thumb">
                    <img src="assets/images/contest/16.png" alt="image">
                    <a href="#0" class="action-icon"><i class="far fa-heart"></i></a>
                    <div class="contest-num">
                      <span>contest no:</span>
                      <h4 class="number">X9U</h4>
