                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-10 col-lg-8">
                            ...
                            <p class="lead">Parabéns! Agora você está pronto
                            para se juntar ao maior número de sortudos que estão
                            cadastrados na nossa plataforma da sorte!</p>
                            <a href="login-client.php">Faça o seu login agora mesmo!</a>
                        </div>
                    </div>
                </div>
            </section>
