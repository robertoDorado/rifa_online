...
$limit = 3;
$countList = $blog->getCount();
$paginaAtual = (isset($_GET['p']) ? intval($_GET['p']) : 1);
$qtdPagina = ceil($countList / $limit);
$offset = ($paginaAtual * $limit) - $limit;
$arrayPosts = $blog->getLimit($offset, $limit);
  ...
  <!-- header-section end  -->
    ...
    <section class="mt-minus-150 pb-120">
      <div class="container">
          ...
          <div class="col-lg-12">
            <section class="text-center">
              <div class="container">
                <div class="row">
                  <div class="col-md-12">
                    <h1>Nossas últimas postagens</h1>
                  </div>
                </div>
              </div>
            </section>
            <!-- <div class="blog-card has-link">
              <a href="blog-single.php" class="item-link"></a>
              <div class="blog-card__thumb"><img src="assets/images/blog/b1.jpg" alt="image"></div>
              <div class="blog-card__content">
                ...
                <div class="left">
                  <span class="post-date">Dece 15, 2020 BY</span>
                  <div class="post-author">
                    <img src="assets/images/blog/author.png" alt="img">
        ...
        <div class="row mt-50" id="select--tab">
          <div class="col-lg-8 mb-none-30">
            <?php if($arrayPosts != array()): ?>
            <?php foreach($arrayPosts as $post): ?>
            <?php $imgThumb = $blog->getImgThumb($post['id']); ?>
            <div class="blog-card style--two mb-30 has-link">
              <a href="blog-single.php?id=<?php echo $post['id']; ?>" class="item-link"></a>
              <div class="blog-card__thumb"><img src="img-blog/<?php echo $imgThumb['img']; ?>" alt="image"></div>
              <div class="blog-card__content">
                <h3 class="blog-card__title tag_search_nome" style="color:#fff;"><?php echo $post['titulo']; ?></h3>
                <ul style="display:none;" class="blog-card__meta">
                  <li>
                    <i class="far fa-comments"></i>
                    <span>20 Comments</span>
                  </li>
                ...
                <div class="overflow-text">
                  <p style="color:#fff;"><?php echo $post['texto']; ?></p>
                </div>
                <div class="blog-card__footer">
                <div class="left">
                <?php
                  $dia = substr($post['date_post'], 8, 2);
                  $mes = intval(substr($post['date_post'], 5, 2)); 
                  $ano = substr($post['date_post'], 0, 4);
                ?>
                  <span class="post-date"><?php echo $dia ." de ". $meses[$mes] . ", " . $ano; ?></span>
                  <div class="post-author">
                    <img src="assets/images/blog/author.jpg" alt="img">
                    <span class="name">Marcel Vincent</span>
                  </div>
                </div>
                </div>
              </div>
            ...
            <?php for($i = 1; $i <= $qtdPagina; $i++): ?>
              <?php if($paginaAtual == $i): ?>
                <a class="btn btn-primary" href="<?php echo $uri->base() . "blog.php?p=" . $i; ?>"><?php echo $i; ?></a>
              <?php else: ?>
                <a href="<?php echo $uri->base() . "blog.php?p=" . $i; ?>"><?php echo $i; ?></a>
              <?php endif; ?>
            <?php endfor; ?>
            <!-- blog-card end -->
          ...
          <aside class="col-lg-4">
            <div class="sidebar">
              <div class="widget">
                ...
                <form class="sidebar-search">
                  <input class="select--inp-search-nome" type="search" name="sidebar-search" id="sidebar-search" placeholder="Pesquise o post aqui">
              ...
              <div class="widget">
                ...
                <div class="small-post-slider">
                  ...
                  <div class="small-post">
                    <div class="small-post__thumb"><img src="img-blog/<?php echo $imgThumb['img']; ?>" alt="image"></div>
                    <div class="small-post__content">

                    <div class="overflow-text">
                      <h3 class="small-post__title"><?php echo $post['titulo']; ?></h3>
                    </div>
                        <!-- <ul class="blog-card__meta">
                          <li>
                            <i class="far fa-comments"></i>
            ...
            <script>
              document.querySelector('.select--inp-search-nome').addEventListener('input', ($input) => {
                // Declare variables
                let filter, col, span, i, txtValue;
                filter = $input.target.value.toLowerCase();
                let row = document.getElementById("select--tab");
                col = row.getElementsByClassName('blog-card')

                // Loop through all list items, and hide those who don't match the search query
                for (i = 0; i < col.length; i++) {
                  span = col[i].getElementsByClassName("tag_search_nome")[0];
            ...
            <!-- Pesquisa na Tabela -->
              ...
              <div class="widget" style="margin-top:30px;">
                <h3 class="widget__title">Siga-nos</h3>
                <ul class="social-link-list">
                  <li><a href="#0"><i class="fab fa-facebook-f"></i></a></li>
                  <li><a href="#0"><i class="fab fa-twitter"></i></a></li>
