...
require_once "vendor/almasaeed2010/adminlte/class/politica-privacidade.class.php";
$user = new User;
...
$arrayPoliticaPrivacidade = $politica->getAll();
?>
...
<section class="hero">
    ...
    <div class="container">
    <?php if($arrayPoliticaPrivacidade != array()): ?>
    <?php foreach($arrayPoliticaPrivacidade as $politicaPrivacidade): ?>
    <div>
        
        <h1 class="title"><?php echo $politicaPrivacidade['titulo']; ?></h1>
        <div class="content-text">
            <?php echo $politicaPrivacidade['texto']; ?>
        </div>
        <div class="col-lg-6">
