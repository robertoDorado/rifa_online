...
if(isset($_POST['numeros-do-cliente'])){
  $numerosCliente = $_POST['numeros-do-cliente'];
  $idCampanha = $_POST['id-contest'];
  $idUsuario = $_POST['id-user'];

  if(!isset($_SESSION['cart'])){
    $_SESSION['cart'] = array();
  }
  if(!isset($_SESSION['cart'][$idCampanha])){
    $_SESSION['cart'][$idCampanha] = $numerosCliente;
  }else{
    $_SESSION['cart'][$idCampanha] = $numerosCliente;
  }
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="cart-wrapper">
              <h2 class="cart-wrapper__title">Meu carrinho</h2>
              <div class="row justify-content-lg-between">
                <div class="col-lg-7">
                  <div class="ticket-wrapper">
                    ...
                    <div class="ticket-wrapper__body">
                      <?php foreach($arrayCart as $itemCart): ?>
                      <?php
                        $arrayNumeros = explode(',', $itemCart['numeros']);
                        $sistemNumberPrice = str_replace('R$', '', $itemCart['preco']);
                        $sistemNumberPrice2 = str_replace(',', '.', $sistemNumberPrice);
                      ?>
                      <div class="single-row">
                        <div class="titulo">
                          <?php $subtotal += (floatval($sistemNumberPrice2) * count($arrayNumeros)); ?>
                          <p><?php echo $itemCart['titulo']; ?></p>
                          <p>Preço por número: <?php echo $itemCart['preco']; ?></p>
                          <p class="numeros">Números: <?php echo $itemCart['numeros']; ?></p>
                          <p>Total de números: <?php echo count($arrayNumeros); ?></p>
                          <p class="id-sorteio">id: #<?php echo substr(md5($itemCart['id']), 0, 3); ?></p>
                        </div>
                        <div class="action-btns">
                           <!-- <button type="button" class="edit-btn"><i class="las la-pen"></i></button> -->
                           <a type="button" href="excluir-item-carrinho.php?id=<?php echo $itemCart['id']; ?>"><i style="font-size:35px;" class="las la-trash-alt"></i></a>
                        </div>
                      </div>
                      <?php endforeach; ?>
                      <!-- single-row end -->
                ...
                <div class="col-lg-4 mt-lg-0 mt-4">
                  <div class="checkout-wrapper">
                    ...
                    <div class="checkout-wrapper__body">
                      ...
                      <!-- <div class="checkout-wrapper__btn"> -->
                        <!-- <button type="submit" class="cmn-btn">comprar números</button> -->
                        <form align="center" action="receber-pagamento.php" method="POST">
                          <input type="hidden" name="total-a-pagar" value="<?php echo $subtotal; ?>">
                          <script
                  ...
                  <div class="mt-30">
                    <img src="assets/images/elements/payment.png" alt="image">
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-12 pt-120">
            <div class="pick-lottery-package">
              <h2 class="title">Contiue as suas Compras!</h2>
              <div class="lottery-package-list">
                <a href="contest.php" class="cmn-btn">Continuar Comprando</a>
              </div>
            </div>
          </div>
          <!-- col-lg-12 -->
