        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="lead">Sua compra foi recusada por algum motivo desconhecido, entre em contato com nosso suporte.</p>
                    <a href="contact.php" class="btn btn-primary">Suporte</a>
                </div>
            </div>
        </div>
    </section>
