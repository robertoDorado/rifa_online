...
if(isset($_GET['id']) && !empty($_GET['id'])){
  $id = $_GET['id'];
  $arrayCurrentPosts = $blog->getPost($id);
  $imgPrincipal1 = $blog->getImgPrincipal1($id);
  $imgPrincipal2 = $blog->getImgPrincipal2($id);
}else{
          ...
          <div class="col-lg-12">
            <div class="blog-single">
              <div class="blog-single__header">
                <?php if($arrayCurrentPosts != array()): ?>
                <h3 class="blog-single__title"><?php echo $arrayCurrentPosts['titulo']; ?></h3>
                <div class="blog-single__meta">
                  <div class="left">
                  <?php
                    $dia = substr($arrayCurrentPosts['date_post'], 8, 2);
                    $mes = intval(substr($arrayCurrentPosts['date_post'], 5, 2)); 
                    $ano = substr($arrayCurrentPosts['date_post'], 0, 4);
                  ?>
              ...
              <div class="blog-single__body">
                <img src="img-blog/<?php echo $imgPrincipal1['img']; ?>" alt="image">
                <p style="text-align:justify; color:#fff;"><?php echo $arrayCurrentPosts['texto']; ?></p>
                <img src="img-blog/<?php echo $imgPrincipal2['img']; ?>" alt="image">
              </div>
            </div><!-- blog-single end -->
            <?php endif; ?>
          </div>
