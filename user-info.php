...
$arrayPurchase = $arrayPurchase = $cart->getPurchase($data['id']);
?>
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <div class="user-action-card">
              ...
              <?php endif; ?>
                <li class="active"><a href="user-info.php">Informações Pessoais</a></li>
          ...
          <div class="col-lg-8 mt-lg-0 mt-5">
            <div class="user-info-card">
              <div class="user-info-card__header">
                <h3 class="user-info-card__title">Detalhes pessoais</h3>
                <button type="button" id="select--user-info"><i class="far fa-edit"></i> Edit</button>
              </div>
              <ul class="user-info-card__list">
                <li>
                  <span class="caption">Nome</span>
                  <span class="value"><?php echo $data['nome']; ?></span>
                </li>
                <li>
                  <span class="caption">Aniversário</span>
                  <span class="value"><?php echo $data['aniversario']; ?></span>
                </li>
                <li>
                  <span class="caption">Endereço</span>
                  <span class="value"><?php echo $data['endereco']; ?></span>
                </li>
              </ul>
            <!-- user-info-card end -->
            <!-- </div>
            ...
            <div class="user-info-card">
              <div class="user-info-card__header">
                <h3 class="user-info-card__title">Email</h3>
                <!-- <button type="button" id="select--user-info-data-email"><i class="far fa-edit"></i> Edit</button> -->
              </div>
              <ul class="user-info-card__list">
                <li>
            ...
            <div class="user-info-card">
              <div class="user-info-card__header">
                <h3 class="user-info-card__title">Telefone</h3>
                <!-- <button type="button" class="select--user-info-data-celular"><i class="far fa-edit"></i> Edit</button> -->
              </div>
              <ul class="user-info-card__list">
                <li>
                  <span class="caption">Celular</span>
                  <span class="value"><?php echo $data['celular']; ?></span>
                </li>
                <li>
                  <span class="caption">Telefone</span>
                  <span class="value"><?php echo $data['telefone']; ?></span>
                </li>
              </ul>
            </div><!-- user-info-card end -->
            <!-- <div class="user-info-card">
              ...
              <ul class="user-info-card__list">
                <li>
                  ...
                  <input style="border:none;" type="password" name="password" id="password" value="<?php echo $data['senha']; ?>" readonly>
                </li>
              </ul>
            </div>user-info-card end -->
          </div>
...
<script>
    document.querySelector('#select--user-info').addEventListener('click', () => {
      window.location.href = 'editar-user-info.php'
    })
</script>