        ...
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8">
                    <h2>Clique no botão abaixo para confirmar o seu e-mail e começar a usar a nossa plataforma!</h2>
                    <form action="pages/controller/email-confirmado.controller.php" method="POST">
                        <input type="hidden" name="token" value="<?php echo $_GET['token']; ?>">
                        <button type="submit" class="btn btn-primary">Confirmar Email</button>
                    </form>
                </div>
            </div>
        </div>
